...
class BombIsland:
    ...
    def __init__(self, tk):
        self.images = {
            "plain": PhotoImage(file = "images/tile_plain.png"),
            "clicked": PhotoImage(file = "images/tile_clicked.png"),
            "mine": PhotoImage(file = "images/tile_mine.png"),
            "flag": PhotoImage(file = "images/tile_flag.png"),
            "wrong": PhotoImage(file = "images/tile_wrong.png"),
            "numbers": []
        }
        for i in range(1, 9):
            self.images["numbers"].append(PhotoImage(file = "images/tile_"+str(i)+".png"))
...
def main():
    ...
    window = Tk()
    # set program title
    window.title("Bomb Island")
    # create game instance
    minesweeper = BombIsland(window)
    # run event loop
    window.mainloop()
